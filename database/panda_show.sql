...
CREATE TABLE tvshow(
	...
	,CONSTRAINT tvshow_PK PRIMARY KEY (id_show)
)ENGINE=InnoDB;
...
CREATE TABLE season(
	...
	,CONSTRAINT season_tvshow_FK FOREIGN KEY (id_show) REFERENCES tvshow(id_show)
)ENGINE=InnoDB;
...
CREATE TABLE my_list(
	...
	,CONSTRAINT my_list_tvshow_FK FOREIGN KEY (id_show) REFERENCES tvshow(id_show)
